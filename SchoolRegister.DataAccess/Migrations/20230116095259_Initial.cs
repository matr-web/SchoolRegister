    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectGroup", x => new { x.GroupsId, x.SubjectsId });
                    table.ForeignKey(
                        name: "FK_SubjectGroup_Groups_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "Groups",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SubjectGroup_Subjects_SubjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectGroup_SubjectsId",
                table: "SubjectGroup",
                column: "SubjectsId");
